  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="ServletCursos?Curso=2">Cursos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="ServletProfesor?perfil=2"><%=session.getAttribute("Nombre")%></a>
      </li>
    </ul>
    <ul class="navbar-nav">
     <li class="nav-item align-right">
        <a class="nav-link" href="ServletUsuario?Usuario=2">Cerrar Sesion</a>
      </li>
    </ul>
  </div>
</nav>
